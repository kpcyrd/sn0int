...
- [Function reference](https://sn0int.readthedocs.io/en/latest/reference.html)
  ...
  - [ws_read_text](https://sn0int.readthedocs.io/en/latest/reference.html#ws-read-text)
  - [ws_read_binary](https://sn0int.readthedocs.io/en/latest/reference.html#ws-read-binary)
  - [ws_read_json](https://sn0int.readthedocs.io/en/latest/reference.html#ws-read-json)
  - [ws_write_text](https://sn0int.readthedocs.io/en/latest/reference.html#ws-write-text)
  - [ws_write_binary](https://sn0int.readthedocs.io/en/latest/reference.html#ws-write-binary)
  - [ws_write_json](https://sn0int.readthedocs.io/en/latest/reference.html#ws-write-json)
