...
pub static FA_BRANDS_400_SVG: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-brands-400.svg");
pub static FA_BRANDS_400_TTF: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-brands-400.ttf");
pub static FA_BRANDS_400_WOFF: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-brands-400.woff");
pub static FA_BRANDS_400_WOFF2: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-brands-400.woff2");
pub static FA_REGULAR_400_SVG: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-regular-400.svg");
pub static FA_REGULAR_400_TTF: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-regular-400.ttf");
pub static FA_REGULAR_400_WOFF: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-regular-400.woff");
pub static FA_REGULAR_400_WOFF2: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-regular-400.woff2");
pub static FA_SOLID_900_SVG: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-solid-900.svg");
pub static FA_SOLID_900_TTF: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-solid-900.ttf");
pub static FA_SOLID_900_WOFF: &[u8] =
    include_bytes!("../assets/fontawesome/webfonts/fa-solid-900.woff");
pub static FA_SOLID_900_WOFF2: &[u8] =
